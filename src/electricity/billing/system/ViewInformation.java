...
public class ViewInformation extends JFrame implements ActionListener{
    ...
    ViewInformation(String meter){
        ...
        meternumber.setBounds(250,160,100,20);
        add(meternumber);
        
        JLabel lbladdress = new JLabel("Address");
        lbladdress.setBounds(100,240,100,20);
        add(lbladdress);
        
        JLabel address = new JLabel("");
        address.setBounds(250,240,100,20);
        add(address);
        
        JLabel lblcity = new JLabel("City");
        lblcity.setBounds(100,320,100,20);
        add(lblcity);
        
        JLabel city = new JLabel("");
        city.setBounds(250,320,100,20);
        add(city);
        ...
        state.setBounds(250,400,100,20);
        add(state);
        ...
        image.setBounds(20, 430, 700, 300);
        add(image);
        setVisible(true);
    }
